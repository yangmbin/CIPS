...
<%
	...
	{
		out.println("评论失败！");
		out.println("<p>" + "1.评论不能为空" + 
			"</p>" + "<form method=\"post\" action=\"comment.jsp?ID="+ID+"\"><input type=\"submit\" value=\"确 定\"></form>");
	}
	else
	{
		//连接本地数据库
		...
		String sql="INSERT INTO comment(id, iid, content, username) VALUES('"+totalItem+"', '"+ID+"', '"+comment+"', '"+name+"')";
