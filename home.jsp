...
<%
	...
	%>
		...
		<%if(curPage>1){%><a href="home.jsp?page=1">首页</a><%}%>&nbsp;&nbsp;

		<%if(curPage>1){%><a href="home.jsp?page=<%=curPage-1%>">上一页</a><%}%>&nbsp;&nbsp;

		<%
		for(int j=1;j<=totalPage;j++)
		{
			out.print("&nbsp;&nbsp;<a href='home.jsp?page="+j+"'>"+j+"</a>");
		}
		%>

		&nbsp;&nbsp;
		<%if(curPage<totalPage){%><a href="home.jsp?page=<%=curPage+1%>">下一页
		</a><%}%>&nbsp;&nbsp;

		<%if(totalPage>1){%><a href="home.jsp?page=<%=totalPage%>">末页</a><%}%>
	<%
	}
	%>
